...
import me from "../assets/img/Majdii.svg";
                    ...
                    <p className="text-white text-4xl">
                      {paragraph.title === "Parcours Académique" || paragraph.title === "Academic background" ? (
                        <>
                          ...
                          <br />
                          <a href="https://www.leaders-university.net/" target="_blank" className="link">
                            Leaders University
                          </a>
                        </>
                      ) : (
                        paragraph.title === "Parcours Professionnel" || paragraph.title === "Career paths" ? (
                          <>
                            {paragraph.description}
                            <br />
                            <a href="https://www.codealpha.tech/" target="_blank" className="link">
                              Code Alpha
                            </a>
                            &
                            <a href="https://www.linkedin.com/company/iprecision/mycompany/" target="_blank" className="link">
                              Iprecision
                            </a>
                          </>
                        ) : (
                          <>
                            {paragraph.description}
                            <br />
                            <a href="https://www.credly.com/users/majdi-akremi" target="_blank" className="link">
                              My Certifications
                            </a>
                          </>     
                        )
